...
public class SequenceDiagramTest {
	...
	public void test5systemManagingManager() {
		...
		assertEquals("system added userJamie123 in userDB", true, userDB.hasUser("userJamie123"));
		
		systemJinho.getUsers();
		
		systemJinho.removeUser("userJamie123");
		assertEquals("system removed userJamie123 in userDB", true, !userDB.hasUser("userJamie123"));
	}
